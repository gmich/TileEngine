namespace TileEngine.Networking.Messages
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class RequestBannerMessage : IGameMessage
    {
        ...
        /// The im.
        /// </param>
        public RequestBannerMessage(NetIncomingMessage im)
        {
            this.Decode(im);
        }

        public RequestBannerMessage(string name, int color, bool isUsingAvatar, int pos)
        {
            this.Name = name;
            this.Color = color;
        ...
        public GameMessageTypes MessageType
        {
            get
            {
                return GameMessageTypes.RequestBannerState;
            }
        }

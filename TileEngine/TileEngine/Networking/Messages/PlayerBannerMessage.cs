namespace TileEngine.Networking.Messages
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class PlayerBannerMessage : IGameMessage
    {
        ...
        /// The im.
        /// </param>
        public PlayerBannerMessage(NetIncomingMessage im)
        {
            this.Decode(im);
        }

        public PlayerBannerMessage(string name, int color, bool isUsingAvatar, int pos)
        {
            this.Name = name;
            this.Color = color;
        ...
        public GameMessageTypes MessageType
        {
            get
            {
                return GameMessageTypes.PlayerBannerState;
            }
        }

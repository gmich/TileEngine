namespace TileEngine.Networking.Messages
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class AddBannerMessage : IGameMessage
    {
        ...
        /// The im.
        /// </param>
        public AddBannerMessage(NetIncomingMessage im)
        {
            this.Decode(im);
        }

        public AddBannerMessage(string name, int color, bool isUsingAvatar, int pos)
        {
            this.Name = name;
            this.Color = color;
        ...
        public GameMessageTypes MessageType
        {
            get
            {
                return GameMessageTypes.AddBannerState;
            }
        }
